...
def m2c(M, nu):   # NOTE Coriolis and centripetal matrix
    """
...
def gvect(W,B,theta,phi,r_bg,r_bb):   # NOTE calculate restoring forces
    """
    ...
    Inputs:
        ...
        r_bb = [x_b y_b z_b]: location of the CB with respect to the CO (m)
